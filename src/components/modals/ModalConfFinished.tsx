      ...
      >
        ...
        <ModalContent>
          ...
          {showBody ? (
            <ModalBody textAlign={"center"} textStyle={"Regular"}>
              <Text mb={"20px"} fontSize="20px">
                Deseja concluir a separaçao do pedido {itens?.general?.orderId}{" "}
                ?
              </Text>
              <Text
                mb={"20px"}
                ...
                borderRadius={"5px"}
              >
                <b>AVISO:</b> Essa ação é irreversível. Tenha certeza.
              </Text>
              {!isAllChecked ? (
                <Text
                  mb={"20px"}
                  ...
                  borderRadius={"5px"}
                >
                  <b>AVISO:</b> Nem todos os pedidos foram conferidos.
                </Text>
              ) : (
                <Text
                  mb={"20px"}
                  ...
                  borderRadius={"5px"}
                >
                  <b>AVISO:</b> Todos os itens foram conferidos, este pedido
                  será <b>FATURADO AUTOMATICAMENTE</b>. Tenha certeza.
                </Text>
              )}
              ...
              <Flex direction={"column"} align={"flex-start"}>
                <Flex gap={"5px"}>
                  ...
                  <Text fontWeight={"bold"}>{itens?.general?.orderId}</Text>
            ...
            <ModalBody textAlign={"center"} textStyle={"Regular"} h={"260px"}>
              <Flex h={"230px"} justify={"center"} align={"center"}>
                <Spinner
                  thickness="10px"
                  speed="0.65s"
                  emptyColor="gray.200"
              ...
              <Flex direction={"column"}>
                ...
                {!isAllChecked ? (
                  <Text
                    ...
                    borderRadius={"5px"}
                  >
                    <b>CONCLUIDO:</b> Nem todos os itens foram conferidos.
                    <br /> Nenhum faturamento foi efetuado para o pedido:{" "}
                    <b>{orderNumbers}</b>.
                  </Text>
                ) : (
                  <Text
                    ...
                    borderRadius={"5px"}
                  >
                    <b>CONCLUIDO:</b> Todos os itens foram conferidos.
                    <br /> O pedido: <b>{orderNumbers}</b>
                    {""}
                    irá aparecer na tela de faturados em 5 minutos após a
            ...
            <ModalBody textAlign={"center"} textStyle={"Regular"}>
              <Flex direction={"column"}>
                <Lottie options={errorLottieOptions} height={250} width={250} />
                <Text
                  mb={"20px"}
                  fontSize={"14px"}
                  bg={"red"}
                  ...
                  borderRadius={"5px"}
                >
                  <b>ERRO:</b> Ocorreu um erro com o seguinte pedido:{" "}
                  <b>{orderNumbers}</b>. <br /> Atualize a página e tente
                  novamente.
                </Text>
              </Flex>
            </ModalBody>
          ...
          <ModalFooter>
            ...
            <Flex
              display={showBody ? "none" : finishConfLoading ? "none" : "flex"}
            >
              <Button
                bg={"#005F27"}
                textColor={"white"}
